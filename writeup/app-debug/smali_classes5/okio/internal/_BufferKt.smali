...
.method public static final commonIndexOf(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1291
    .local v7, "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    if-nez v6, :cond_4
    ...
    .end local v7    # "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    .local v24, "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    int-to-long v6, v6
    ...
    invoke-static {v14, v7, v12, v10, v15}, Lokio/internal/_BufferKt;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .end local v24    # "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    .end local v28    # "$this$seek$iv":Lokio/Buffer;
    .end local v29    # "$i$f$seek":I
    .end local v30    # "s$iv":Lokio/Segment;
    .local v5, "$this$seek$iv":Lokio/Buffer;
    .local v6, "s":Lokio/Segment;
    .restart local v7    # "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    ...
    .end local v7    # "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    .local v6, "a$iv":I
    .restart local v24    # "$i$a$-seek-_BufferKt$commonIndexOf$5":I
    ...
    invoke-static {v10, v6, v14, v7, v2}, Lokio/internal/_BufferKt;->rangeEquals(Lokio/Segment;I[BII)Z
...
.method public static final commonIndexOfElement(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1325
    .local v14, "$i$a$-seek-_BufferKt$commonIndexOfElement$2":I
    return-wide v12

    .end local v6    # "offset":J
    .end local v11    # "s":Lokio/Segment;
    .end local v14    # "$i$a$-seek-_BufferKt$commonIndexOfElement$2":I
    :cond_1
    nop
    ...
    .line 1325
    .local v7, "$i$a$-seek-_BufferKt$commonIndexOfElement$2":I
    if-nez v6, :cond_3
    ...
    .line 1805
    .end local v7    # "$i$a$-seek-_BufferKt$commonIndexOfElement$2":I
