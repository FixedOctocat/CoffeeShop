...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/BufferedSource;Lokio/BufferedSink;)V
    ...
    invoke-direct {v0, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lokio/BufferedSource;)V
...
.method private final newChunkedSink()Lokio/Sink;
    ...
    .line 215
    .local v1, "$i$a$-check-Http1ExchangeCodec$newChunkedSink$1":I
    ...
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$newChunkedSink$1":I
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/Source;
    ...
    .line 233
    .local v1, "$i$a$-check-Http1ExchangeCodec$newChunkedSource$1":I
    const-string v2, "state: "
    ...
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$newChunkedSource$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method private final newFixedLengthSource(J)Lokio/Source;
    ...
    .line 227
    .local v1, "$i$a$-check-Http1ExchangeCodec$newFixedLengthSource$1":I
    const-string v2, "state: "
    ...
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$newFixedLengthSource$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method private final newKnownLengthSink()Lokio/Sink;
    ...
    .line 221
    .local v1, "$i$a$-check-Http1ExchangeCodec$newKnownLengthSink$1":I
    const-string v2, "state: "
    ...
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$newKnownLengthSink$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method private final newUnknownLengthSource()Lokio/Source;
    ...
    .line 239
    .local v1, "$i$a$-check-Http1ExchangeCodec$newUnknownLengthSource$1":I
    const-string v2, "state: "
    ...
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$newUnknownLengthSource$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method public readResponseHeaders(Z)Lokhttp3/Response$Builder;
    ...
    .line 176
    .local v1, "$i$a$-check-Http1ExchangeCodec$readResponseHeaders$1":I
    const-string v2, "state: "
    ...
    .line 173
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$readResponseHeaders$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 163
    iget-object v5, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/BufferedSink;
    ...
    .line 166
    invoke-interface {v5, v3}, Lokio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    .line 160
    .local v1, "$i$a$-check-Http1ExchangeCodec$writeRequest$1":I
    const-string v2, "state: "
    ...
    .end local v1    # "$i$a$-check-Http1ExchangeCodec$writeRequest$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
